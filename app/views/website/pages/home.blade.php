                        ...
                        <div class="carousel-inner text-center">
                            <div class="active item">
                                <blockquote>
                                    ...
                                    <h3>La recomiendo. La ropa es súper linda :)</h3>
                                    <footer><em><strong>Maria Pinzón</strong>, Villavicencio</em></footer>
                                </blockquote>
                            </div>
                            <div class="item">
                                <blockquote>
                                    <p><img src="{{ URL::to('img/placeholders/avatars/06.jpg') }}" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar-2x"></p>
                                    <h3>La calidad y comodidad es lo mejor!. Muchas Gracias</h3>
                                    <footer><em><strong>Nubia Puentes</strong>, Villavicencio</em></footer>
                                </blockquote>
                            </div>
                            <div class="item">
                                <blockquote>
                                    <p><img src="{{ URL::to('img/placeholders/avatars/12.jpg') }}" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar-2x"></p>
                                    <h3>Tiene prendas a muy buen precio, sobre todo la ropa interior</h3>
                                    <footer><em><strong>Sonia Ortega</strong>, Bogotá</em></footer>
                                </blockquote>
                            </div>
                            <div class="item">
                                <blockquote>
                                    <p><img src="{{ URL::to('img/placeholders/avatars/09.jpg') }}" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar-2x"></p>
                                    <h3>Estoy Feliz con Alba Boutique, me encanta la atención</h3>
                                    <footer><em><strong>Vanesa Hernandez</strong>, Acacias</em></footer>
                                </blockquote>
                            </div>
                        </div>
                    </div>
